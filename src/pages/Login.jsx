  ...
  return (
    <div className="login-container">
      <style>{`
        ...
        .top-banner { position:absolute; top:0; width:100%; background:#1a1a1a; color:#fff; text-align:center; padding:15px 0; font-size:1.2rem; font-weight:900; letter-spacing:3px; box-shadow:0 4px 10px rgba(0,0,0,0.3); z-index:10; text-transform:uppercase; }
        ...
        .login-btn { width:100%; padding:14px; background:#0056b3; color:white; border:none; border-radius:10px; font-size:16px; font-weight:bold; margin-top:10px; cursor:pointer; transition:.3s; }
